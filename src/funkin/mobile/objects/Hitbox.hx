...
{
	final offsetFir:Int = Std.int(FlxG.height / 4) * 3; // (ClientPrefs.data.hitboxPos ? Std.int(FlxG.height / 4) * 3 : 0);
	final offsetSec:Int = 0; // (ClientPrefs.data.hitboxPos ? 0 : Std.int(FlxG.height / 4));
